...
AC_DEFUN(ATTAL_PRINT_QT_PROGRAM,
[
AC_LANG_CPLUSPLUS
...
## ------------------------------------------------------------------------
##
AC_DEFUN(AC_PATH_QT_2_2,
[
AC_REQUIRE([K_PATH_X])

AC_MSG_CHECKING([for QT])
ac_qt_includes=NO ac_qt_libraries=NO ac_qt_bin=NO
qt_libraries=""
qt_includes=""
AC_ARG_WITH(qt-dir,
...
if test "$ac_qt_includes" = NO || test "$ac_qt_libraries" = NO; then
  ...
  AC_MSG_ERROR([QT-2.2 $ac_qt_notfound not found. Please check your installation! ]);
else
  have_qt="yes"
fi
])
...
AC_DEFUN(AC_PATH_ATTAL,
[ 
AC_REQUIRE([ATTAL_MISC_TESTS])
...
AC_DEFUN(AM_ATTAL_WITH_NLS,
  [AC_MSG_CHECKING([whether NLS is requested])
    ...
    if test "$USE_NLS" = "yes"; then
      ...
      AM_PATH_PROG_WITH_TEST_ATTAL(MSGFMT, msgfmt, 
      ...
      AM_PATH_PROG_WITH_TEST_ATTAL(XGETTEXT, xgettext,
...
dnl AM_PATH_PROG_WITH_TEST_ATTAL(VARIABLE, PROG-TO-CHECK-FOR,
dnl   TEST-PERFORMED-ON-FOUND_PROGRAM [, VALUE-IF-NOT-FOUND [, PATH]])
AC_DEFUN(AM_PATH_PROG_WITH_TEST_ATTAL,
...
AC_DEFUN(AM_KDE_GNU_GETTEXT,
  [AC_REQUIRE([AC_PROG_MAKE_SET])dnl
   ...
   AC_REQUIRE([AM_ATTAL_WITH_NLS])dnl
